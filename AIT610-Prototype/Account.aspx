            ...
            <div class="grid">
                ...
                <div class="form-row mt-3">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        ...
                        <input type="number" required="required" class="form-control" id="zipCode" aria-describedby="zipCode" placeholder="Enter your Zip Code."
                            oninvalid="this.setCustomValidity('Please enter a zip code.')"
                            oninput="setCustomValidity('')" />
                        <small id="zipCodeeHelp" class="form-text text-muted">Please enter your last name.</small>
                ...
                <div class="form-row mt-3">
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                        ...
                        <input type="email" class="form-control" id="userEmail" placeholder="Enter your email. " required="required"
                            ...
                            oninput="setCustomValidity('')" />
                        <small id="userEmailHelp" class="form-text text-muted">Please enter your email. Your email address will be used as your username. </small>
                    </div>
                </div>
                ...
                <div class="form-row mt-lg-3">
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-24">
                        <input type="checkbox" required="required" class="form-check-input" id="termsCheckBox" />
                        <label class="checkBoxConditions" for="termsCheckBox">By checking this box you agree to our terms and conditions.</label>
                    </div>
                </div>
